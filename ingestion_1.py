...
# ==========================================
#  --- KONFIGURACE SYSTÉMU (ZAŘÍZENÍ 1) ---
# ==========================================
MQTT_BROKER_IP = "127.0.0.1"

# Původní parametry pro ble_1 zachovány
BLE_CONFIGS = [
    {
        "id": "ble_1",
...
# Původní parametry pro radar_1 zachovány
RADAR_CONFIGS = [
    {
        "id": "radar_1",
...
def db_worker():
    ...
    print("DB Worker (Zařízení 1): Připraven k asynchronnímu zápisu.")
...
if __name__ == "__main__":
    ...
    print("Zařízení 1: Sběr dat spuštěn. Ukončete pomocí Ctrl+C.")
    try:
        while True:
            time.sleep(1)
